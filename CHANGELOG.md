...
* update deps ([c35d403](https://github.com/image-charts/mjml-chart/commit/c35d403))
* update deps ([9f048ce](https://github.com/image-charts/mjml-chart/commit/9f048ce))
...
* docs(changelog): updated ([dbbae9e](https://github.com/image-charts/mjml-chart/commit/dbbae9e))
* docs(changelog): updated ([bdfacef](https://github.com/image-charts/mjml-chart/commit/bdfacef))
* docs(changelog): updated ([936a591](https://github.com/image-charts/mjml-chart/commit/936a591))
